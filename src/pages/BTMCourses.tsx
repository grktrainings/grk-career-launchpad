      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          ...
          <div className="text-center mb-12">
            <Badge className="mb-4 bg-primary/10 text-primary">BTM Layout Campus</Badge>
            <h1 className="text-4xl md:text-5xl font-bold text-foreground mb-6">
              Available <span className="text-primary">Courses</span> at BTM Layout
            </h1>
            <div className="bg-card rounded-lg p-6 max-w-3xl mx-auto mb-8">
              <div className="flex flex-col md:flex-row items-center justify-center gap-4 text-sm">
                <div className="flex items-center gap-2">
                  <MapPin className="h-4 w-4 text-primary" />
                  <span>2nd Floor, 12, 20th Main Rd, Old Madiwala, Maruti Nagar, 1st Stage, BTM Layout</span>
                </div>
                <div className="flex items-center gap-2">
          ...
          <div className="mt-16 grid grid-cols-1 md:grid-cols-4 gap-6">
            <Card className="text-center p-6">
              <div className="text-3xl font-bold text-primary mb-2">Smart Classrooms</div>
              <p className="text-muted-foreground">Interactive learning</p>
            </Card>
            <Card className="text-center p-6">
              <div className="text-3xl font-bold text-primary mb-2">Project Lab</div>
              <p className="text-muted-foreground">Hands-on practice</p>
            </Card>
            <Card className="text-center p-6">
              <div className="text-3xl font-bold text-primary mb-2">Study Area</div>
              <p className="text-muted-foreground">Quiet learning space</p>
            </Card>
            <Card className="text-center p-6">
              <div className="text-3xl font-bold text-primary mb-2">Metro Access</div>
              <p className="text-muted-foreground">Easy connectivity</p>
            </Card>
          </div>
        </div>
      </section>
